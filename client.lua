...
function HandcuffsAction()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'menu', {
		...
		elements = {
            ...
            {label = 'Wsadź do bagażnika', value = 'bagol'},
            {label = 'Wyciągnij z bagażnika', value = 'bagol1'},
		}
	}, function(data, menu)
        ...
        elseif data.current.value == 'handcuff' then
          ...
          --  ESX.ShowNotification('~o~Przenosisz obywatela ~b~' .. GetPlayerServerId(closestPlayer))
            exports["golden_taskbar"]:taskBar(1000, "Łapanie/Puszczanie", false, true)
